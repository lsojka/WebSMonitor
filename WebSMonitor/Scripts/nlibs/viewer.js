...
Viewer.prototype.EmptyScene = function ()
{
    if (models.length > 0 || this.objects.length > 0)
    {
        //console.log("Scene non empty. Drop " + models.length + " models, " + this.objects.length + " objects");
        mx = models.pop();
        this.removeObject(mx);
        this.update();
        //console.log("After emptying = " + models.length + " models, " + this.objects.length + " objects");
    }
}
